...
register(
    id='uav-downlink-2d-v4',
    entry_point='gym.envs.UAV:Downlink_2d_v4',
    )
register(
    id='uav-downlink-2d-v5',
    entry_point='gym.envs.UAV:Downlink_2d_v5',
    )
register(
...
register(
    id='discrete-action-uav-dynamical-2d-v0',
    entry_point='gym.envs.UAV:dis_2d_dynamical_v0',
    )

register(
    id='discrete-action-uav-stable-2d-v0',
    entry_point='gym.envs.UAV:dis_2d_stable_v0',
    )
# UAV2
# --------
register(
    id='uav-C2Ddy-v0',
    entry_point='gym.envs.UAV:Downlink_C2Ddy',
    )
register(
    id='uav-C2Dst-v0',
    entry_point='gym.envs.UAV:Downlink_C2Dst',
    )
register(
    id='uav-D2Ddy-v0',
    entry_point='gym.envs.UAV:Downlink_D2Ddy',
    )
register(
    id='uav-D2Ddy-v1',
    entry_point='gym.envs.UAV:Downlink_D2Ddy_v1',
    )
register(
    id='uav-D2Dst-v0',
    entry_point='gym.envs.UAV:Downlink_D2Dst',
    )
register(
    id='Dwithblock-v0',
    entry_point='gym.envs.UAV:Dwithblock',
    )
register(
    id='Ddelay-v0',
    entry_point='gym.envs.UAV:Ddelay',
    )
register(
    id='C2Ddy_controlP-v0',
    entry_point='gym.envs.UAV:C2d_controlP_V0',
    )
# UAV3 11-11
# --------
register(
    id='CH2dB-v0',
    entry_point='gym.envs.UAV:CH2dwithblock',
    )
register(
    id='CH3dB-v0',
    entry_point='gym.envs.UAV:CH3d_block_V0',
    )
register(
    id='C3dB-v0',
    entry_point='gym.envs.UAV:C3d_block_V0',
    )
register(
    id='C2dB-v0',
    entry_point='gym.envs.UAV:C2dwithblock',
    )
register(
    id='D3dB-v0',
    entry_point='gym.envs.UAV:D3d_block_V0',
    )
register(
    id='D2dB-v0',
    entry_point='gym.envs.UAV:D2dwithblock',
    )


register(
    id='DL2dB-v0',
    entry_point='gym.envs.UAV:DL2dwithblock',
    )

register(
    id='DL3dB-v0',
    entry_point='gym.envs.UAV:DL3dwithblock',
    )
...
register(
    id='C2d-v0',
    entry_point='gym.envs.UAVblock:C2d',
    )
register(
    id='HLC2d-v0',
    entry_point='gym.envs.UAVblock:HLC2d',
    )
register(
    id='LLC2d-v0',
    entry_point='gym.envs.UAVblock:LLC2d',
    )

register(
    id='LLD2d-v0',
    entry_point='gym.envs.UAVblock:LLD2d',
    )


register(
    id='D_place_action-v0',
    entry_point='gym.envs.UAVblock:D_place_action_2d',
    )