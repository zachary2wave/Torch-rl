import gym
import time
from Torch_rl.algorithm.SPPO import PPO_Agent
...
Agent = PPO_Agent(env, policy_model, value_model, gamma=0.90,
            lr=1e-4, running_step=2048, batch_size=64, value_train_round=10, path=path)

Agent.train(max_step=1500000, render=False, verbose=2, record_ep_inter=1)
